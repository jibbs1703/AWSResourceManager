...
class S3Handler:
    ...
    def create_bucket(self, bucket_name: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"An AWS client error occurred while creating S3 bucket {bucket_name}: {e}"
            )  # noqa: E501
    ...
    def generate_presigned_url(
        self, bucket_name: str, object_name: str, expiration: int = 600
    ) -> str:
        """
    ...
    def delete_file(self, bucket_name: str, file_name: str):
        ...
        try:
            ...
            return (
                f"Client Error: Unable to delete the file '{file_name}' "
            ...
            return (
                f"Error: Unexpected error occurred while deleting the file '{file_name}'"
